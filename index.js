...
mortgageCalculator(200000, 0.05, 360);
...
mortgageCalculator(200000, 0.05, 360, 750)
...
for (let i = (I - .02) ;i <= (I + .02); I = I + .005 ) {
  let monthlyInterestRate = i/12;
  let years = 30;
  let N = years*12; // months or periods
  let n1 = Math.pow((monthlyInterestRate+1), N);
  let numerator = monthlyInterestRate * P * n1;
  let denominator = n1 -1;
  let M = numerator/denominator;
    ...
    return M;
		...
		console.log(`${name}, with an interest rate of ${I.toFixed(3)}, your monthly rate is ${M}`);
	}
}
variableInterestRate(200000, .04, 360, 750);
